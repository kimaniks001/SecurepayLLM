 ...
 * Availability is a WORD plus a status dot. The dot's colour states the listing's own factual status
 * (open / limited / unconfirmed / closed) -- it never says one seller or result is better than another,
 * and no card styling, order or colour implies "recommended", "best" or "top".
 * The place is the seller's own written text, shown as plain text: no map pin, no distance, no "nearby".
 *
