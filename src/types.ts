...
export type AppView = 'signed-out' | 'signed-in' | 'conversation' | 'agreements' | 'agreement-detail' | 'dispute' | 'agreement-builder' | 'money' | 'store' | 'community' | 'circle' | 'ecosystem' | 'projects' | 'vision-board' | 'account' | 'settings' | 'recovery' | 'business' | 'developer';
