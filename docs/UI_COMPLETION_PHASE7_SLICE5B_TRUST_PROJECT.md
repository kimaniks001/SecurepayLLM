...
- **Technologies:** SecurePay/KS001, Store, SecureLinks, Community.
...
- **Store:** "Your Store is your digital economic presence, tied to your KS Number. It can start empty … A Store is not an endorsement." This is true today: see the Store finding below.
...
- **"How this started"** (collapsed): problem → principles → technology → community.
...
- `node --test tests/*.test.mjs`: 1286/1286 (new `tests/ui-phase7-trust-project.test.mjs`, 16 tests).
